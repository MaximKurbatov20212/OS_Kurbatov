...
// Если бит не установлен, то будет два "Couldn't open file", тк SUID бит не установлен(нет прав), а то, что мы поменяли эффективный адрес на реальный
// ничем не поможет.
// Если бит установлен, вначале мы сможем открыть файл, но потом мы установим бит эффективного идентификатора пользователя на реальный и прав опять не будет.
